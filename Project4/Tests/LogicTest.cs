...
namespace Tests {
    ...
    public class LogicTest {
        ...
        public void BookTest() {
            ...
            Assert.IsTrue(library.AddBook(new Services.Model.Book(1, 100)));
            Assert.IsTrue(library.DeleteBook(100));
            Assert.IsTrue(library.GetBook(1).Catalog.Books.Count == 3);
            Assert.IsTrue(library.GetBook(1).Catalog.Books[0].IdNumber == 1);
        }
